...
GoogleMusic.prototype = {
  ...
  get _eplayPause () { return doc.querySelector('button[data-id="play-pause"]'); },
  get _eforward () { return doc.querySelector('button[data-id="forward"]'); },
  get _erewind () { return doc.querySelector('button[data-id="rewind"]'); },
  get _eshuffle () { return doc.querySelector('button[data-id="shuffle"]'); },
